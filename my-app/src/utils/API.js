...
export default {
    ...
    current: function() {
        return axios.get("https://api.openweathermap.org/data/2.5/weather?zip=20001,us&appid=5735b3e048f694014a7f656569a5b4d4");
    },
    fiveDay: function (){
        return axios.get("https://api.openweathermap.org/data/2.5/forecast?zip=20001&appid=5735b3e048f694014a7f656569a5b4d4")
    }
};
